...
namespace OxxCommerceStarterKit.Web.Models.CustomProperties
{
    ...
    /// </summary>
    /// <remarks>For an example, see SitePageData where this property type is used for the MetaKeywords property</remarks>
    [EditorHint(WebGlobal.SiteUIHints.Strings)]
