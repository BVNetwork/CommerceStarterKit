...
<div class="Form__Element FormSelection form-group " data-epiforms-element-name="<%: formElement.ElementName %>" >
    <label for="<%: formElement.Guid %>" class="Form__Element__Caption control-label"><%: labelText %></label>
