...
<div class="Form__Element FormTextbox FormTextbox--Textarea form-group <%: Model.GetValidationCssClasses() %>" data-epiforms-element-name="<%: formElement.ElementName %>" >
    <label for="<%: formElement.Guid %>" class="Form__Element__Caption"><%: labelText %></label>
    <textarea name="<%: formElement.ElementName %>" id="<%: formElement.Guid %>" class="FormTextbox__Input form-control" 
        placeholder="<%: Model.PlaceHolder %>" rows="3" data-epiforms-label="<%: labelText %>" 
